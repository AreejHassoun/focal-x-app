...
const Color kGreyD9 = Color(0xffC7C9D9);
const Color kGreyFA = Color(0xffF6F7FA);
const Color kGrey8C = Color(0xff8C8C8C);

const Color kOrange = Color(0xFFFF8500);
const Color kLightOrange = Color(0xFFFCCC75);
...
const double kBorderRadius7 = 7.0;
